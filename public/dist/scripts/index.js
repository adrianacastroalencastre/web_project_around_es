...
//
function getCardElement(name = "Sin titulo", link = "./images/placeholder-image.png") {
...
function openModal(modal) {
    ...
    (0, validate_js_1.setEventListeners)(forms);
...
function closeModal(modal) {
    ...
    if (formElement) {
        (0, validate_js_1.resetValidation)(formElement);
    }
