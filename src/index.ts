...
// perfil
const titleProfile = document.querySelector('.profile__title') as HTMLElement;
const descriptionProfile = document.querySelector('.profile__description') as HTMLElement;
...
const profileAvatar = document.querySelector('.profile__image') as HTMLImageElement;

//buttons profile 
const buttonEditOpen = document.querySelector('.profile__edit-button') as HTMLButtonElement;
const buttonAddOpen = document.querySelector('.profile__add-button') as HTMLButtonElement;
const buttonAvatarOpen = document.querySelector('.profile__avatar-button') as HTMLButtonElement;

// forms
const formEditProfile = document.querySelector('#edit-profile-form') as HTMLFormElement;
const formAddCard = document.querySelector('#new-card-form') as HTMLFormElement;
const formEditAvatar = document.querySelector('#edit-avatar-form') as HTMLFormElement;

// edit profile 
const nameInput = document.querySelector('.popup__input_type_name') as HTMLInputElement;
const descriptionInput = document.querySelector('.popup__input_type_description') as HTMLInputElement;

// container tarjetas
const listCard = document.querySelector('.cards__list') as HTMLElement;
